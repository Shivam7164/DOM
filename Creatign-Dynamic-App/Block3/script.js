...
Div2.style.paddingLeft="6rem"
Div2.style.paddingTop="1.5rem"

let gotName = [];
for(let arr of got.houses){
  for (let name of arr.people){
      gotName.push(name)
  }
}
gotName.forEach((ele)=>{
    ...
    Div.setAttribute("class","boxShow")
    Div.style.backgroundColor="rgb(255,255,255)"
    Button.style.margin="1rem 0"
   Div.prepend(Div1)
   Div1.append(Img,h2)
   Div1.style.margin="1rem 0"
   Div1.style.display="flex"
   Div1.style.alignItems="center"
   h2.style.fontSize="1.3rem"
   para.style.lineHeight="1.5rem"
   let Figure = document.createElement("figure")
    Div1.prepend(Figure)
    Figure.append(Img)
    Figure.style.width="20%"
    Figure.style.fontSize="0"
    Figure.style.marginRight="1.2rem"
    a.style.textDecoration="none"
    Button.style.width="100%"
    Button.style.padding="0.5rem 0"
    Button.style.borderRadius="5px"
    Button.style.backgroundColor="rgb(231,237,253)"
